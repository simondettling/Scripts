...
Function Install-ConsoleExtension {
    ...
    Invoke-MessageBox -Message "Console Extension successfully installed/updated. Please restart all open Consoles." -Icon Information
}
...
Function Remove-ConsoleExtension {
    ...
    Invoke-MessageBox -Message "Console Extension successfully removed. Please restart all open Consoles." -Icon Information
}
